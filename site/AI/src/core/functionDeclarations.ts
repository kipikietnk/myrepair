...
const callbacks: CallbackMap<CallbackDefinitions> = {
  showImage: (args) => {
    ...
    const img = modal.querySelector(".zoomable-image") as HTMLImageElement;
    const backdrop = modal.querySelector(".image-modal-backdrop") as HTMLDivElement;
    ...
    function updateTransform() {
      const container = modal.querySelector(".image-container") as HTMLDivElement;
